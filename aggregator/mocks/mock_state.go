...
// DeletePublishedAttestationIds provides a mock function with given fields: ctx, attestationId, dbTx
func (_m *StateMock) DeletePublishedAttestationIds(ctx context.Context, attestationId types.U64, dbTx pgx.Tx) error {
	ret := _m.Called(ctx, attestationId, dbTx)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, types.U64, pgx.Tx) error); ok {
		r0 = rf(ctx, attestationId, dbTx)
	} else {
		r0 = ret.Error(0)
	}
...
// IsAttestationPublishedOnL1 provides a mock function with given fields: ctx, attestationId, dbTx
func (_m *StateMock) IsAttestationPublishedOnL1(ctx context.Context, attestationId types.U64, dbTx pgx.Tx) (bool, error) {
	ret := _m.Called(ctx, attestationId, dbTx)

	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.U64, pgx.Tx) (bool, error)); ok {
		return rf(ctx, attestationId, dbTx)
	}
	if rf, ok := ret.Get(0).(func(context.Context, types.U64, pgx.Tx) bool); ok {
		r0 = rf(ctx, attestationId, dbTx)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, types.U64, pgx.Tx) error); ok {
		r1 = rf(ctx, attestationId, dbTx)
	} else {
		r1 = ret.Error(1)
	}
