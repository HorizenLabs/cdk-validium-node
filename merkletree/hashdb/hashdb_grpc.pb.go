...
func (c *hashDBServiceClient) SemiFlush(ctx context.Context, in *SemiFlushRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/hashdb.v1.HashDBService/SemiFlush", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterHashDBServiceServer(s *grpc.Server, srv HashDBServiceServer) {
	s.RegisterService(&_HashDBService_serviceDesc, srv)
}
...
func _HashDBService_SemiFlush_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hashdb.v1.HashDBService/SemiFlush",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _HashDBService_serviceDesc = grpc.ServiceDesc{
